    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary font-medium text-sm mb-8 animate-fade-up">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-6 animate-fade-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mt-8 animate-fade-up" style={{ animationDelay: '0.4s' }}>
            <a href="#" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
              ...
              <span className="text-sm font-medium">Download Enterprise Whitepaper</span>
            </a>
            <span className="text-muted-foreground/30">|</span>
            <a href="#" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
              <Phone className="w-4 h-4" />
              <span className="text-sm font-medium">Speak with Compliance Specialist</span>
            </a>
          </div>
        </div>
      </div>
