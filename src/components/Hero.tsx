        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 animate-fade-up" style={{ animationDelay: '0.1s' }}>
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-medium">
              Stop re-training employees on skills they've already mastered. Prove workforce competency to auditors instantly. Keep your organization compliant with ISO 27001, GDPR, and NIS2—without the administrative burden.
            </p>
          </div>
